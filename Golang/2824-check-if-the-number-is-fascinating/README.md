<h2><a href="https://leetcode.com/problems/check-if-the-number-is-fascinating">Check if The Number is Fascinating</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>You are given an integer <code>n</code> that consists of exactly <code>3</code> digits.</p>
